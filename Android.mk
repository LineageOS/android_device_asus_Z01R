...
APD_MOUNT_POINT := $(TARGET_OUT_VENDOR)/APD
$(APD_MOUNT_POINT): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating $(ADF_MOUNT_POINT)"
	@mkdir -p $(TARGET_OUT_VENDOR)/APD

ASDF_MOUNT_POINT := $(TARGET_OUT_VENDOR)/asdf
$(ASDF_MOUNT_POINT): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating $(ASDF_MOUNT_POINT)"
	@mkdir -p $(TARGET_OUT_VENDOR)/asdf
...
ALL_DEFAULT_INSTALLED_MODULES += $(FIRMWARE_MOUNT_POINT) $(ADF_MOUNT_POINT) $(APD_MOUNT_POINT) $(ASDF_MOUNT_POINT) $(BT_FIRMWARE_MOUNT_POINT) $(DSP_MOUNT_POINT) $(FACTORY_MOUNT_POINT)
...
$(RFS_MSM_MPSS_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	...
	$(hide) ln -sf /vendor/firmware_mnt $@/readonly/firmware
	$(hide) ln -sf /vendor/firmware $@/readonly/vendor/firmware
	$(hide) ln -sf /vendor/firmware_mnt $@/readonly/vendor/firmware_mnt
