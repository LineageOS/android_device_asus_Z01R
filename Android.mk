...
APD_MOUNT_SYMLINK := $(TARGET_OUT_VENDOR)/
$(APD_MOUNT_SYMLINK): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating APD mount symlink: $@"
	$(hide) ln -sf /APD $@/APD

ASDF_MOUNT_SYMLINK := $(TARGET_OUT_VENDOR)/
$(ASDF_MOUNT_SYMLINK): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating APD mount symlink: $@"
	$(hide) ln -sf /asdf $@/asdf

ALL_DEFAULT_INSTALLED_MODULES += $(APD_MOUNT_SYMLINK) $(ASDF_MOUNT_SYMLINK)
